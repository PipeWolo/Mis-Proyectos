...
function selectTime(ctl,ctl2) {
	...
	textCtl=ctl2;
	currentCtl2 = ctl
	currentCtl2.src=imagePath + "timepicker2.gif";
	...
	crossobj2.left =	ctl.offsetLeft	+ leftpos 
	crossobj2.top = ctl.offsetTop +	toppos + ctl.offsetHeight +	2 
	crossobj2.visibility=(dom||ie2)? "visible" : "show"
...
function closeTimePicker() {
	...
	showElement( 'SELECT' );
	showElement( 'APPLET' );
	currentCtl2.src=imagePath + "timepicker.gif"
}

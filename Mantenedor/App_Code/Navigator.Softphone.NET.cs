...
namespace Navigator.Softphone
{
    ...
    public class Softphone
    {
        ...
        public void DiscarFono(string fono,string cs, string skill)
        {
            try
            {
                if (client != null && client.SharedObject.Validate())
                {
                    client.SharedObject.RequestMakeCall(fono);
                }
            }
            catch (Exception ex)
            {
        ...
        public void Discar(string cs, string skill, string vdn)
        {
            try
            {
                if (client != null && client.SharedObject.Validate())
                {
                    ...
                    client.SharedObject.RequestBlindTransfer(vdn,cs,skill,"1","1");
                }
            }
            catch (Exception ex)
            {
        ...
        public void IniciarTransf(string ani, string cs, string skill, string agente)
        {
            try
            {
                if (client != null && client.SharedObject.Validate())
                {
                    ...
                    client.SharedObject.RequestBlindTransfer(ani, cs, skill, "1", "1");
                   //client.SharedObject.RequestMakeCall(ani, cs, skill, "1", "1");
                }
            }
            catch (Exception ex)
            {

...
public partial class Reportes_Main : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static RetornoAjax Cargar(string id)
    {

        MantenedorSegmentoxAgente Serv = new MantenedorSegmentoxAgente();

        return Serv.Cargar(id);
    ...
    [WebMethod]
    public static RetornoAjax SubirCargaAgentexCampana(List<SegmentoxAgente> segxagente)
    {
        var ajax = new MantenedorSegmentoxAgente();
        return ajax.SubirCargaAgentexCampana(segxagente);
    }
}